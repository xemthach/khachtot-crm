...
$route['default_controller']   = 'kt_landing/kt_landing_public';
$route['404_override']         = '';
$route['translate_uri_dashes'] = false;
...
$route['admin/kt_landing'] = 'kt_landing/kt_landing_admin/index';
$route['admin/kt_landing/settings'] = 'kt_landing/kt_landing_admin/settings';
$route['admin/kt_landing/themes'] = 'kt_landing/kt_landing_admin/themes';
$route['admin/kt_landing/customizer'] = 'kt_landing/kt_landing_admin/customizer';
$route['admin/kt_landing/pages'] = 'kt_landing/kt_landing_admin/pages';
$route['admin/kt_landing/sections'] = 'kt_landing/kt_landing_admin/sections';
$route['admin/kt_landing/section_items'] = 'kt_landing/kt_landing_admin/section_items';
$route['admin/kt_landing/menu'] = 'kt_landing/kt_landing_admin/menu';
$route['admin/kt_landing/media'] = 'kt_landing/kt_landing_admin/media';
$route['admin/kt_landing/pricing'] = 'kt_landing/kt_landing_admin/pricing';
$route['admin/kt_landing/addons'] = 'kt_landing/kt_landing_admin/addons';
$route['admin/kt_landing/blog'] = 'kt_landing/kt_landing_admin/blog';
$route['admin/kt_landing/leads'] = 'kt_landing/kt_landing_admin/leads';
$route['admin/kt_landing/seo'] = 'kt_landing/kt_landing_admin/seo';
$route['admin/kt_landing/analytics'] = 'kt_landing/kt_landing_admin/analytics';
$route['admin/kt_landing/clone'] = 'kt_landing/kt_landing_admin/clone_engine';
$route['admin/kt_landing/publish'] = 'kt_landing/kt_landing_admin/publish';
$route['admin/kt_landing/preview'] = 'kt_landing/kt_landing_admin/preview';
$route['admin/kt_landing/preview/(:any)'] = 'kt_landing/kt_landing_admin/preview/$1';
 ...
 */
$route[''] = 'kt_landing/kt_landing_public/home';
$route['pricing'] = 'kt_landing/kt_landing_public/pricing';
$route['blog'] = 'kt_landing/kt_landing_public/blog';
$route['signup'] = 'kt_landing/kt_landing_public/signup';
$route['signup/status'] = 'kt_landing/kt_landing_public/signup_status';
$route['signup/progress/(:any)'] = 'kt_landing/kt_landing_public/signup_progress/$1';
$route['signup/check-subdomain'] = 'kt_landing/kt_landing_public/signup_subdomain_check';
$route['contact/submit'] = 'kt_landing/kt_landing_public/contact_submit';
