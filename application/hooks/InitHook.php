...
function _app_init()
{
    ...
    // Bootstrap tenant context before App_modules reads tblmodules.
    $tenantBootstrapPath = APPPATH . 'hooks' . DIRECTORY_SEPARATOR . 'KtSaasTenantBootstrap.php';
    if (file_exists($tenantBootstrapPath)) {
        include_once $tenantBootstrapPath;
