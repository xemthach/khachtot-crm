    ...
    public function getBadge($feature)
    {
        ...
        if (method_exists($this, $feature)) {
            try {
                ...
                log_message('error', 'CustomerProfileBadges failed for feature [' . $feature . '] customer [' . $this->customerId . ']: ' . $e->getMessage());
            }
        }
        ...
        try {
            ...
            log_message('error', 'CustomerProfileBadges hook failed for feature [' . $feature . '] customer [' . $this->customerId . ']: ' . $e->getMessage());
            $hook = ['badge' => $badge];
        }
