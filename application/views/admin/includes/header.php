    ...
    <nav>
        <div class="tw-flex tw-justify-between">
            ...
            <ul class="nav navbar-nav navbar-right -tw-mt-px">
                ...
                <?php if (staff_can('view', 'settings') || (function_exists('kt_saas_can_manage_workspace_settings') && kt_saas_can_manage_workspace_settings())) { ?>
                <li>
                    <a
                        href="<?= function_exists('kt_saas_settings_url') ? kt_saas_settings_url() : admin_url('settings'); ?>">
                        <?= _l('settings'); ?>
                    </a>
                </li>
                <?php } ?>
