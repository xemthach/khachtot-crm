...
<script>
    $(function() {
        ...
        settingsForm.on('submit', function() {
            ...
            if (emailProtocol === 'microsoft' || emailProtocol === 'google' || emailProtocol === 'brevo_api') {
        ...
        $('input[name="settings[email_protocol]"]').on('change', function() {
            ...
            if ($(this).val() == 'mail') {
                ...
                $('.brevo-api-fields').addClass('hide');
                resetFields();
            } else if ($(this).val() == 'brevo_api') {
                $('.smtp-fields').addClass('hide');
                $('.xoauth-hide').addClass('hide');
                $('.xoauth-microsoft-show').addClass('hide');
                $('.xoauth-google-show').addClass('hide');
                $('.brevo-api-fields').removeClass('hide');
                resetFields();
