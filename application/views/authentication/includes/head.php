...
<head>
    ...
    <title>
        <?php echo e((function_exists('kt_saas_auth_context') && ($ctx = kt_saas_auth_context()) && !empty($ctx['company_name'])) ? $ctx['company_name'] : get_option('companyname')); ?> - <?php echo _l('admin_auth_login_heading'); ?>
    </title>
