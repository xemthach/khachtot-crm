...
class AdminController extends App_Controller
{
    public function __construct()
    {
        ...
        if (function_exists('kt_saas_is_tenant_runtime')
            ...
            && function_exists('kt_saas_is_landlord_only_admin_route')
            && kt_saas_is_landlord_only_admin_route(uri_string())) {
            show_error('This system area is available only in landlord context.', 403, 'Forbidden');
        }
